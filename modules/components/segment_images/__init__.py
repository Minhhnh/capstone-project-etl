...
from modules.components.segment_images.palette import palette
...
def process_image(
    image: bytes, *, processor: SegformerImageProcessor, device: str
) -> torch.Tensor:
    """
...
class SegmentImagesComponent:
    """
    Component that segments images using a model from the Hugging Face hub.
    """

    def __init__(self, model_id: str = "openmmlab/upernet-convnext-small"):
        """
